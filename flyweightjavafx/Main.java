...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			pane.setBorder(BorderFactory.INSTANCE.getRedBorder()); // Aseta punainen kehys FlowPaneen
			...
			reset.setBorder(BorderFactory.INSTANCE.getGreenBorder()); // Aseta vihreä kehys Reset-nappiin
